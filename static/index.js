...
let record = null;
let audioChunks = [];
let audio_duration = 0; // Duration in milliseconds

let developMode = true; // Set to false to run in hosting platform (PythonAnyways)
...
random_button_element.onclick = () => {
    ...
    prompted_audio_element.onloadedmetadata = function () {
        audio_duration = prompted_audio_element.duration * 1000; // Duration in milliseconds
    };
